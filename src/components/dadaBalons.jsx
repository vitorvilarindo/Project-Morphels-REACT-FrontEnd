...
function DataBalons({type, date, title, value, payment, color_value, color_category, onDelete, showEditForm}) {
  const cores = {
  ...
  return (
    ...
    >
      <nav className="flex gap-3">
        <p className={`text-xs text-blue-300 ${classeCorCategory[0]} ${classeCorCategory[1]} px-2 py-1 rounded-lg items-center`}>
          {type}
        </p>
