        ...
        <form action={() => handleSubmit(onEditRevenue)()} className="flex flex-col  space-y-3">
                ...
                <section className="flex flex-row gap-4 w-full">
                  <div className="flex flex-col items-start w-full">
                    ...
                    <select id="type" className="w-full text-xs bg-gray-100 border rounded-md border-gray-100 hover:cursor-auto focus:border-gray-400 focus:outline-none placeholder:text-gray-500 focus:ring-gray-400 px-2 py-2" {...register("type")} defaultValue={complete.type}>
                  ...
                  <div className="flex flex-col items-start w-full">
                    ...
                    <SearchBar placeholder="00,0" type="number"  id="value" {...register("value")} defaultValue={complete.value}/>
                  </div>
                </section >
                <section className="flex flex-row gap-4 w-full">
                  <div className="flex flex-col items-start w-full">
                ...
                <div className="w-full flex flex-row mt-4 gap-4 ">
                      ...
                      <button onClick={onHideForm} className="bg-white border text-xs border-gray-200 shadow-xs text-black px-4 py-2 rounded-lg hover:bg-slate-200 transition-discrete">Cancel</button>
                  </div>
              </form>
